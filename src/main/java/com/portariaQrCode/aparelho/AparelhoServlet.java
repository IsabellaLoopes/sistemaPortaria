package com.portariaQrCode.aparelho;
...
@WebServlet(description = "Aparelho", loadOnStartup = 5, urlPatterns = {"/cadastro/aparelhoCabecalho", 
						"/cadastro/aparelhoIncluir", "/cadastro/aparelhoSalvar", "/cadastro/aparelhoListar", 
						"/cadastro/aparelhoStatus", "/cadastro/aparelhoEditar"})
