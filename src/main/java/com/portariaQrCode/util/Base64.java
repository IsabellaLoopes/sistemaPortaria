...
public class Base64 {
	private final static char[] map = { '1', 'a', 'g', 'M', 'n', 'T', 'U', '-', 'A', '2', 'h', 'L', 'o', 'S', 's', '+',
			'B', 'b', '3', 'K', 'p', 'R', 'V', 'w', 'C', 'c', 'i', '4', 'q', 'Q', 'v', 'W', 'D', 'd', 'j', 'J', '5',
			'P', 'x', 'Z', 'E', 'e', 'k', 'I', 'r', '6', 'X', 'z', 'F', '0', 'l', 'H', 't', 'O', '7', 'y', '9', 'f',
			'm', 'G', 'u', 'N', 'Y', '8' };
	...
	public final static byte[] decode(String s) throws Base64Exception {
		int nb;
		...
		for (int i = 0; i < s.length(); i += 4) {
			...
			if ((b1 < 0) || (b2 < 0))
				throw new Base64Exception("decode invalid character ");
			nb = 3;
			if (b[i + 3] == '=')
				nb = 2;
			if (b[i + 2] == '=')
