...
<body>
<div class="modal fade in" tabindex="-1" role="dialog" id="modal-incluir-pessoa">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content p-3">
			<div class="modal-header">
				<h5 class="modal-title nomeTopo">INCLUIR PESSOA</h5>
			...
			<div class="modal-footer">	
				<button type="button" class="btn btn-form" onclick="salvarPessoa()">Continuar <i class="fa fa-arrow-right"></i></button>      
			</div>
		</div>
	</div>
</div>
