...
<body>
<div class="modal fade in" tabindex="-1" role="dialog" id="modal-perfil-usuario">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content p-3">
			<div class="modal-header">
				<h5 class="modal-title nomeTopo">EDITAR PERFIL</h5>
				<button type="button" class="close btn" data-dismiss="modal" aria-label="Close" onclick="fecharModal('modal-perfil-usuario')">
